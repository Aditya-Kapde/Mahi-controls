...
import { Lock, Mail, ChevronRight, AlertCircle, ArrowLeft, Home, ShieldCheck } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0F172A] relative flex items-center justify-center overflow-hidden font-inter">
      ...
      >
        <div className="flex justify-center mb-6">
          <Link to="/" className="inline-flex items-center gap-2 text-slate-400 hover:text-white transition-colors font-medium text-sm bg-slate-800/50 px-4 py-2 rounded-full border border-slate-700/50 hover:border-slate-600 shadow-lg">
            <ArrowLeft className="w-4 h-4" />
            Back to Homepage
          </Link>
        </div>
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-200/50">
          <div className="bg-[#0F172A] px-8 py-8 text-center border-b border-slate-800">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="admin@mahicontrols.com"
                    autoComplete="email"
                    inputMode="email"
                    autoCapitalize="none"
                  />
