...
import { LayoutDashboard, Inbox, Package, LogOut, Search, Bell, ShieldCheck } from 'lucide-react';
...
const AdminLayout = () => {
  ...
  // Helper to get active page name for breadcrumb
  ...
  return (
    <div className="flex h-screen bg-[#F8FAFC] font-inter overflow-hidden">
      ...
      {/* Sidebar Navigation */}
      <aside className="w-64 bg-[#0F172A] flex flex-col shadow-xl z-20">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8 z-10 shadow-sm">
          <div className="flex items-center gap-4">
            <h1 className="text-lg font-semibold text-slate-800 font-poppins">{activePageName}</h1>
